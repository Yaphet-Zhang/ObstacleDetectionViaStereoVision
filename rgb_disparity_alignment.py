...
camRgb.setFps(fps)
if downscaleColor: camRgb.setIspScale(2, 3) # stereo:rgb
...
with device:
    ...
    while True:
        ...
        if latestPacket["rgb"] is not None:
            ...
            # # save
            # np.save('../data/0003/rgb{}'.format(str(c)), frameRgb) # npy
        ...
        if latestPacket["rectifiedLeft"] is not None and latestPacket["rectifiedRight"] is not None:
            ...
            # # save
            # np.save('../data/0003/leftright{}'.format(str(c)), imOut) # npy   
        ...
        if latestPacket["disp"] is not None:
            ...
            # # save
            # np.save('../data/0003/disparity{}'.format(str(c)), frameDisp) # npy            
            ...
            # # save
            # np.save('../data/0003/depth{}'.format(str(c)), frameDepth) # npy
        ...
        if frameRgb is not None and frameDisp is not None:
            ...
            blended_resized = cv2.resize(blended, (640, 480)) # just for show
