# https://github.com/luxonis/depthai-experiments/tree/master/gen2-anomaly-detection
# https://github.com/h1day/ind_knn_ad
...
with dai.Device(pipeline) as device:
    ...
    while True:
        # image = cv2.imread(r'../data/image/0002.jpg')
        # image = cv2.resize(image, (256, 256))

        image = qColor.get().getCvFrame() # (256, 256, 3)

        out = qNN.get() # inference
